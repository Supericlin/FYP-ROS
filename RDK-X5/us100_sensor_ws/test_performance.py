#!/usr/bin/env python3
"""
Performance test script for optimized US100 ultrasonic sensor node
"""
...
def test_performance():
    """Test the performance of the optimized ultrasonic sensor node"""
    print("🚀 Testing Optimized US100 Ultrasonic Sensor Performance")
    print("=" * 60)
    
    # Build the package first
    print("📦 Building package...")
    try:
        subprocess.run(["colcon", "build", "--packages-select", "us100_sensor_pkg"], 
    ...
    print("🎯 Launching optimized sensor node...")
    try:
        # Launch with optimized settings
        process = subprocess.Popen([
            "ros2", "launch", "us100_sensor_pkg", "us100_sensor_launch.py",
            "log_interval:=30.0",
            "debug_mode:=false",
