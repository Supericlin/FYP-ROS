...
class SparkBotEs8311AudioCodec : public Es8311AudioCodec {
 ...
 public:
  SparkBotEs8311AudioCodec(void* i2c_master_handle, i2c_port_t i2c_port,
      ...
      : Es8311AudioCodec(i2c_master_handle, i2c_port, input_sample_rate,
                         output_sample_rate, mclk, bclk, ws, dout, din, pa_pin,
                         es8311_addr, use_mclk = true) {}
...
class EspSparkBot : public WifiBoard {
 ...
 public:
  ...
  virtual void InitializeIot() override {
    ...
    thing_manager.AddThing(iot::CreateThing("DuMqtt"));
  }
