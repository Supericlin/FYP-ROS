...
def generate_launch_description():
    return LaunchDescription([
        ...
        # Node Enable/Disable Parameters
        DeclareLaunchArgument(
            'enable_fall_detection',
            default_value='true',
            description='Enable fall detection system'
        ),
        DeclareLaunchArgument(
            'enable_ultrasonic',
            default_value='true',
            description='Enable ultrasonic sensors'
        ),
        ...
        Node(
            ...
            output='screen',
            emulate_tty=True,
            condition=IfCondition(LaunchConfiguration('enable_fall_detection')),
        ),
        ...
        # Launch Ultrasonic Sensors Node
        Node(
            package='ultrasonic_sensors',
            executable='ultrasonic_node2',
